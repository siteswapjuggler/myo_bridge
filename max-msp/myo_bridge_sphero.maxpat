...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.5, 402.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "s SPHERO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 10.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 38.0, 111.0, 20.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.0, 11.0, 64.0, 18.0 ],
					"style" : "",
					"text" : "receive Myo"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 173.0, 100.0, 83.0, 51.0 ],
									"style" : "",
									"text" : "roll\nspeed [0-255]\nheading [0-359]\nbreaking [0-1]"
								}
...
,
					"patching_rect" : [ 166.5, 374.0, 116.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 263.5, 101.0, 86.0, 20.0 ],
					"style" : "",
					"text" : "OSC-route /pose"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.5, 349.0, 46.0, 18.0 ],
					"style" : "",
					"text" : "heading"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.5, 349.0, 38.0, 18.0 ],
					"style" : "",
					"text" : "speed"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 189.0, 125.0, 153.0, 22.0 ],
									"style" : "",
									"text" : "scale -0.14 0.14 100. -100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 182.0, 73.0, 35.0 ],
									"style" : "",
									"text" : "clip -100. 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 125.0, 118.0, 35.0 ],
									"style" : "",
									"text" : "scale -0.1 0.1 -100. 100."
								}
...
,
					"patching_rect" : [ 44.0, 280.0, 62.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 320.5, 307.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 118.0, 227.0, 79.0, 22.0 ],
									"style" : "",
									"text" : "vexpr $f1-$f2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 320.5, 134.0, 32.0, 22.0 ],
									"style" : "",
									"text" : "t 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 269.5, 134.0, 32.0, 22.0 ],
									"style" : "",
									"text" : "t 1 b"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 269.5, 100.0, 70.0, 22.0 ],
									"style" : "",
									"text" : "togedge"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 269.5, 190.0, 32.0, 22.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 118.0, 307.0, 30.0, 30.0 ],
									"style" : ""
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 279.0, 218.5, 127.5, 218.5 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 59.5, 218.5, 187.5, 218.5 ],
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 292.0, 167.5, 59.5, 167.5 ],
									"source" : [ "obj-39", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 343.0, 183.5, 279.0, 183.5 ],
									"source" : [ "obj-40", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 79.5, 183.5, 292.0, 183.5 ],
									"source" : [ "obj-88", 0 ]
								}
...
,
					"patching_rect" : [ 44.0, 256.0, 458.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 50.0, 125.0, 37.0, 20.0 ],
													"style" : "",
													"text" : "* 180."
												}
...
,
									"patching_rect" : [ 193.0, 136.0, 64.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 161.0, 136.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 136.0, 111.0, 22.0 ],
									"style" : "",
									"text" : "scale 30 100 0 255"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 193.0, 185.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "% 360"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 193.0, 161.0, 40.0, 22.0 ],
									"style" : "",
									"text" : "+ 270"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 193.0, 265.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 166.5, 322.0, 116.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 263.5, 348.0, 50.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 166.5, 348.0, 50.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 322.0, 100.0, 100.0 ],
					"rightvalue" : 100,
					"style" : "",
					"topvalue" : 100
				}
...
,
									"patching_rect" : [ 13.0, 90.0, 48.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 120.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 223.0, 157.0, 142.0, 22.0 ],
									"style" : "",
									"text" : "qmetro 100 hz @active 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 46.0, 193.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 239.5, 50.0, 22.0 ],
									"style" : "",
									"text" : "round 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 215.5, 65.0, 22.0 ],
									"style" : "",
									"text" : "smoov 0.8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 130.0, 94.0, 22.0 ],
									"style" : "",
									"text" : "prepend symbol"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 66.0, 155.0, 145.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
									"style" : "",
									"text" : "coll pose-gate @embed 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 319.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 232.5, 186.5, 55.5, 186.5 ],
									"source" : [ "obj-27", 0 ]
								}
...
,
					"patching_rect" : [ 263.5, 150.0, 98.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 126.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "$1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 44.0, 63.0, 91.0, 20.0 ],
					"style" : "",
					"text" : "OSC-route /myo/0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 263.5, 181.0, 64.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 483.0, 373.0, 122.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 322.0, 59.0, 20.0 ],
					"style" : "",
					"text" : "/unlock 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.0, 322.0, 60.0, 20.0 ],
					"style" : "",
					"text" : "/vibrate 0 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.075806, 224.0, 34.0, 18.0 ],
					"style" : "",
					"text" : "pitch",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.075806, 188.5, 26.0, 18.0 ],
					"style" : "",
					"text" : "roll",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 44.0, 101.0, 111.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 150.0, 74.0, 20.0 ],
					"style" : "",
					"text" : "vexpr $f1 - 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 179.0, 191.0, 68.0 ],
					"setminmax" : [ -0.5, 0.5 ],
					"setstyle" : 3,
					"size" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 10.0, 90.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 352.0, 245.5, 492.5, 245.5 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 53.5, 92.0, 273.0, 92.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 53.5, 312.5, 176.0, 312.5 ],
					"source" : [ "obj-96", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 555.5, 358.5, 492.5, 358.5 ],
					"source" : [ "obj-99", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Dropbox/02. PROGRAMMATION/[prog] Processing/myo_bridge/max-msp",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
